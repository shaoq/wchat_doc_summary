...
This project is indexed by GitNexus as **wchat_doc_summary** (7395 symbols, 11473 relationships, 226 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
