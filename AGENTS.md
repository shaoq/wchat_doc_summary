...
This project is indexed by GitNexus as **wchat_doc_summary** (12905 symbols, 21302 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
