...
This project is indexed by GitNexus as **wchat_doc_summary** (10263 symbols, 16771 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
