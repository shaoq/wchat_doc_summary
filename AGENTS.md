...
This project is indexed by GitNexus as **wchat_doc_summary** (7258 symbols, 11184 relationships, 224 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
