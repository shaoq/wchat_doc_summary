...
This project is indexed by GitNexus as **wchat_doc_summary** (7090 symbols, 10924 relationships, 222 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
